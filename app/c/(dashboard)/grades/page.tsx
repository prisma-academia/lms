    ...
    <div>
      ...
      {grades.length === 0 ? (
        ...
        <div className="grid gap-4 lg:grid-cols-[300px_1fr]">
          <div className="flex flex-col items-center gap-4 rounded-[14px] border-2 border-ink bg-card p-6 text-center shadow-brutal">
            <div
            ...
            <p className="text-[12.5px] font-medium text-ink/60">
          ...
          <div className="flex flex-col gap-4">
            ...
            {top ? (
              <div
                className="flex items-center gap-3 rounded-[14px] border-2 border-ink bg-card p-4"
                style={{ boxShadow: "5px 5px 0 var(--orange)" }}
              >
                <span className="flex size-11 shrink-0 items-center justify-center rounded-[10px] border-2 border-ink bg-orange text-ink">
                ...
                <div className="min-w-0">
                  ...
                  <span className="num text-[12.5px] font-medium text-ink/60">
