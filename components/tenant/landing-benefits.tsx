...
export function LandingBenefits() {
  return (
    <section id="benefits" className="scroll-mt-24 border-t-2 border-border">
      <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {BENEFITS.map((f) => (
            <div
              key={f.title}
              className="rounded-[14px] border-2 border-border bg-card p-5 text-card-foreground shadow-md transition-transform hover:-translate-x-0.5 hover:-translate-y-0.5"
            >
              <span
